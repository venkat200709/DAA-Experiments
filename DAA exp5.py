...
comparison_count = 0  # Global counter for Divide & Conquer comparisons
...
def min_max_dc(arr, low, high):
  ...
  # Conquer: combine left/right results with 2 comparisons
  comparison_count += 1
...
print(
    f'\n{"Size":>8} {"DC Comps":>12} {"Naive Comps":>14}'
    f' {"Formula 3n/2-2":>16}'
)
print('-' * 54)
...
for size in [10, 100, 1000, 10000]:
  ...
  # Theoretical formula: ceil(3n / 2) - 2
  formula = (3 * size) // 2 - 2
